...
def ficha(jog='<desconhecido>', gol=0):    #utilização de parametros opcionais
    print(f'O jogador {jog} fez {gol} gol(s) no campeonato.')


#Programa Principal
n= str(input("Nome do jogador: "))
g= str(input("Número de gols: "))# Recebeu str porque se não passar parametro nenhum ira dar erro!
if g.isnumeric():
    g = int(g)
else:
    g = 0
